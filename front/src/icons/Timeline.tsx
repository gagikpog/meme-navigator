...
export default function IconTimeline({size = 24}: IIconProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" stroke="currentColor" fill="#fff" strokeWidth="2" strokeLinecap="round">
